...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('pula.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite('wall_grad.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('wall_grad.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('puppy.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('puppy.png',   win_width - 125, win_height - 125, 125, 125)

monster = Enemy('wolf.png',  win_width - 140, 150, 140, 140, 3)
